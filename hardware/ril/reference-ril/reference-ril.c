...
#endif
#define REFERENCE_RIL_VERSION    "Quectel_Android_RIL_SR01A40V40"
...
#define nwscanmodeex_auto (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5))
    ...
    tmp = old_nwscanmodeex & (~nwscanmodeex_tdscdma); //Android donot support td-scdma settings
    if (0) 
        old_rat = PREF_NET_TYPE_GSM_WCDMA;
    else if (tmp == nwscanmodeex_gsm)
        old_rat = PREF_NET_TYPE_GSM_ONLY;
    else if (tmp == nwscanmodeex_wcdma)
        old_rat = PREF_NET_TYPE_WCDMA;
    else if (tmp == (nwscanmodeex_gsm | nwscanmodeex_wcdma))
        old_rat = PREF_NET_TYPE_GSM_WCDMA_AUTO;
    else if (tmp == (nwscanmodeex_cdma | nwscanmodeex_evdo))
        old_rat = PREF_NET_TYPE_CDMA_EVDO_AUTO;
    else if (tmp == nwscanmodeex_cdma)
        old_rat = PREF_NET_TYPE_CDMA_ONLY;
    else if (tmp == nwscanmodeex_evdo)
        old_rat = PREF_NET_TYPE_EVDO_ONLY; 
    else if (tmp == (nwscanmodeex_gsm | nwscanmodeex_wcdma | nwscanmodeex_cdma | nwscanmodeex_evdo))
        old_rat = PREF_NET_TYPE_GSM_WCDMA_CDMA_EVDO_AUTO;
    else if (tmp == (nwscanmodeex_lte | nwscanmodeex_cdma | nwscanmodeex_evdo))
        old_rat = PREF_NET_TYPE_LTE_CDMA_EVDO;
    else if (tmp == (nwscanmodeex_lte | nwscanmodeex_gsm | nwscanmodeex_wcdma))
        old_rat = PREF_NET_TYPE_LTE_GSM_WCDMA;
    else if (tmp == (nwscanmodeex_lte | nwscanmodeex_cdma | nwscanmodeex_evdo | nwscanmodeex_gsm | nwscanmodeex_wcdma))
        old_rat = PREF_NET_TYPE_LTE_CMDA_EVDO_GSM_WCDMA;
    else if (tmp == nwscanmodeex_lte)
        old_rat = PREF_NET_TYPE_LTE_ONLY;
#if RIL_VERSION >= 9
    else if (tmp == (nwscanmodeex_gsm | nwscanmodeex_wcdma))
        old_rat = PREF_NET_TYPE_LTE_WCDMA;
#endif    
    else if (tmp == 0)
        old_rat = PREF_NET_TYPE_LTE_CMDA_EVDO_GSM_WCDMA;
    else
...
//pay attention, the default PreferredNetworkType is NETWORK_MODE_WCDMA_PREF
//it is not suitable for LTE modules.
...
//must change to NETWORK_MODE_LTE_CMDA_EVDO_GSM_WCDMA in order to use 4G
    switch (new_rat) {
        case PREF_NET_TYPE_GSM_WCDMA: //                = 0, /* GSM/WCDMA (WCDMA preferred) */
            new_nwscanmodeex = 0; //you can change to (nwscanmodeex_gsm | nwscanmodeex_wcdma), if you know what you are doing
        break;
        case PREF_NET_TYPE_GSM_ONLY: //                 = 1, /* GSM only */
            new_nwscanmodeex = nwscanmodeex_gsm;
        break;
        case PREF_NET_TYPE_WCDMA: //                    = 2, /* WCDMA  */
            new_nwscanmodeex = nwscanmodeex_wcdma;
        break;
        case PREF_NET_TYPE_GSM_WCDMA_AUTO: //           = 3, /* GSM/WCDMA (auto mode, according to PRL) */
            new_nwscanmodeex = nwscanmodeex_gsm | nwscanmodeex_wcdma;
        break;
        case PREF_NET_TYPE_CDMA_EVDO_AUTO: //           = 4, /* CDMA and EvDo (auto mode, according to PRL) */
            new_nwscanmodeex = nwscanmodeex_cdma | nwscanmodeex_evdo;
        break;
        case PREF_NET_TYPE_CDMA_ONLY: //                = 5, /* CDMA only */
            new_nwscanmodeex = nwscanmodeex_cdma;
        break;
        case PREF_NET_TYPE_EVDO_ONLY: //                = 6, /* EvDo only */
            new_nwscanmodeex = nwscanmodeex_evdo;
        break;
        case PREF_NET_TYPE_GSM_WCDMA_CDMA_EVDO_AUTO: // = 7, /* GSM/WCDMA, CDMA, and EvDo (auto mode, according to PRL) */
            new_nwscanmodeex = 0; //nwscanmodeex_gsm | nwscanmodeex_wcdma | nwscanmodeex_cdma | nwscanmodeex_evdo;
        break;
        case PREF_NET_TYPE_LTE_CDMA_EVDO: //            = 8, /* LTE, CDMA and EvDo */
            new_nwscanmodeex = 0; //nwscanmodeex_lte | nwscanmodeex_cdma | nwscanmodeex_evdo;
        break;
        case PREF_NET_TYPE_LTE_GSM_WCDMA: //            = 9, /* LTE, GSM/WCDMA */
            new_nwscanmodeex = 0; //nwscanmodeex_lte | nwscanmodeex_gsm | nwscanmodeex_wcdma;
        break;
        case PREF_NET_TYPE_LTE_CMDA_EVDO_GSM_WCDMA: //  = 10, /* LTE, CDMA, EvDo, GSM/WCDMA */
            new_nwscanmodeex = 0; //nwscanmodeex_lte | nwscanmodeex_cdma | nwscanmodeex_evdo | nwscanmodeex_gsm | nwscanmodeex_wcdma;
        break;
        case PREF_NET_TYPE_LTE_ONLY: //                 = 11  /* LTE only */
            new_nwscanmodeex = nwscanmodeex_lte;
        break;
#if RIL_VERSION >= 9
        case PREF_NET_TYPE_LTE_WCDMA: //                 = 12  /* LTE/WCDMA */ 
            new_nwscanmodeex = nwscanmodeex_lte | nwscanmodeex_wcdma;
        break;
#endif
        default:
            new_nwscanmodeex = 0; //Auto
        break;
    }

    if ((new_nwscanmodeex & (nwscanmodeex_lte | nwscanmodeex_wcdma)) == (nwscanmodeex_lte | nwscanmodeex_wcdma))
        new_nwscanmodeex |= nwscanmodeex_tdscdma; //maybe you miss ts-scdma

    if (old_nwscanmodeex == 0)
        old_nwscanmodeex = nwscanmodeex_auto;
    if (new_nwscanmodeex == 0)
        new_nwscanmodeex = nwscanmodeex_auto;
...
#if 1 //This command is used to enable or disable DTMF detection.
        at_send_command("AT+QTONEDET=1", &p_response);
