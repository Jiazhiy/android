...
#endif
#ifndef	WLAN_MODULE_RTL8723BU
#define WLAN_MODULE_RTL8723AU  //for rtl8723au
#endif
enum Vendor {
    UNKNOWN = -1,
    ATHEROS = 0x1,
...
#ifdef WLAN_MODULE_RTL8723AU
#define WIFI_DRIVER_MODULE_PATH_REALTEK          "/system/lib/modules/8723au.ko"
#define WIFI_DRIVER_MODULE_NAME_REALTEK          "8723au"
#elif defined(WLAN_MODULE_RTL8723BU)
...
int wifi_load_driver()
{
    ...
    int ret;
#ifdef WLAN_MODULE_RTL8723AU
    ALOGE("%s WLAN_MODULE_RTL8723AU\n",__func__);
    WifiVendor = REALTEK;
#elif defined(WLAN_MODULE_RTL8723BU)
    ALOGE("%s WLAN_MODULE_RTL8723BU\n",__func__);
    WifiVendor = REALTEK;
#else
