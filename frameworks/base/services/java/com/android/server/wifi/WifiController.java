...
class WifiController extends StateMachine {
     ...
     */
    private static final long DEFAULT_REENABLE_DELAY_MS = 2000; //change by dg for debug 500-2000 ms,it is important for mt6620 that have enough time to run in kernel space and hardware.
