...
public class EthernetDataTracker extends BaseNetworkStateTracker {
    ...
    /* add by cym 20151130 */
    private static boolean no_netline_insert = false;
    /* end add */
    ...
    private static class InterfaceObserver extends BaseNetworkObserver {
		...
		/* add by cym 20151130 */
		if(no_netline_insert && up)
		{
			Log.d(TAG, "Interface " + iface + " restart");
			interfaceAdded(iface);

			no_netline_insert = false;
